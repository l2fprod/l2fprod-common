...
public class ResourceManagerUnitTest extends TestCase {
  ...
  public void testAll() {
    ...
    assertEquals("value formatted", rm.getString("format",
    ...
    assertEquals(
        "value",
        ResourceManager
            .resolve("${com.l2fprod.common.util.ResourceManagerUnitTest$BundleRB:key}"));
    assertEquals("value formatted", ResourceManager.resolve(
        "${com.l2fprod.common.util.ResourceManagerUnitTest$BundleRB:format}",
        new Object[]{"formatted"}));
  }
  ...
  public static class BundleRB extends ListResourceBundle {
    ...
    protected Object[][] getContents() {
      return new Object[][]{
          {"key", "value"},
          {"nestedKey",
              "${com.l2fprod.common.util.ResourceManagerUnitTest$BundleRB:key}"},
          {"format", "value {0}"}};
    }
  }
}